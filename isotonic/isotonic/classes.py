...
class ISVR(BaseEstimator,RegressorMixin):
    ...
    def fit(self,X,y,version="greedy"):
        ...
        self.intercept_, self.energie_dual_, self.n_iter_,self.sub_,self.delta_, self.A = SMO_solver(X,y,version=version,C=self.C,nu=self.nu,max_it=self.max_iter,precision=self.tol)
